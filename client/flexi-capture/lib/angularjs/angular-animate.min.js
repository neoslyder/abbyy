...
(function(Y, z) {
  ...
  function T(a, b, c) {
    ...
    c.preparationClasses &&
      ((d.preparationClasses = ba(c.preparationClasses, d.preparationClasses)), delete c.preparationClasses);
  ...
  var qa = ca + 'Delay',
    ...
    Xa = { transitionDuration: Na, transitionDelay: na, animationDuration: Ca, animationDelay: qa },
    Da,
    wa,
    s,
    Z,
  ...
  z.module('ngAnimate', [], function() {
    ...
    .provider('$$animateQueue', [
      ...
      function(a) {
        function b(a) {
          return { addClass: a.addClass, removeClass: a.removeClass, from: a.from, to: a.to };
        }
        function c(a) {
          if (!a) return null;
          a = a.split(' ');
                ...
                for (var d = x(g), t = 0; t < d.length; t++)
                  for (var f = d[t], e = 0; e < f.length; e++) {
                    ...
                    0 === t
                      ...
                      : (h = k.data('$$animatePrepareClasses')) && a.addClass(k, h);
                  }
                Q(d);
              });
              return F;
            ...
            return function(a, b) {
                ...
                function b() {
                  if (!P) {
                    ...
                    p.applyAnimationDelay &&
                      ((ga = 'boolean' !== typeof g.delay && ya(g.delay) ? parseFloat(g.delay) : ga),
                      (W = Math.max(ga, 0)),
                      (r.animationDelay = ga),
                      (ea = [qa, ga + 's']),
                      y.push(ea),
              ...
              0 < g.stagger
                ? ((B = parseFloat(g.stagger)),
                  (X = { transitionDelay: B, animationDelay: B, transitionDuration: 0, animationDuration: 0 }))
                : (X = C(l, V, ka, Xa));
              ...
              p.applyTransitionDuration =
                O && ((p.hasTransitions && !p.hasTransitionAll) || (p.hasAnimations && !p.hasTransitions));
              ...
              if (p.applyTransitionDuration || p.applyAnimationDuration)
                (D = g.duration ? parseFloat(g.duration) : D),
                  ...
                  p.applyAnimationDuration &&
                    ((p.hasAnimations = !0), (r.animationDuration = D), y.push([Ca, D + 's']));
              ...
              g.skipBlocking ||
                ...
                (p.blockKeyframeAnimation =
                  0 < r.animationDuration && 0 < X.animationDelay && 0 === X.animationDuration));
            ...
            function C(c, e, f) {
              ...
              function v() {
                var c = L(f.attr('class') || ''),
                  d = x(c, q),
                  c = x(q, c),
                  d = a(h, { to: k(f), addClass: 'ng-anchor-in ' + d, removeClass: 'ng-anchor-out ' + c, delay: !0 });
            ...
            return function(a, b, d, x) {
              ...
              function H(a, b, d, e, f) {
                ...
                if (0 === h.length) {
                  ...
                  'beforeSetClass' === f
                    ...
                    : 'setClass' === f &&
                      ((k = A(a, 'removeClass', d, e, 'removeClass')), (q = A(a, 'addClass', d, e, 'addClass')));
                  k && (h = h.concat(k));
                  q && (h = h.concat(q));
                }
                if (0 !== h.length)
              ...
              if (G.length) {
                ...
                'leave' === b
                  ...
                  : ((h = 'before' + b.charAt(0).toUpperCase() + b.substr(1)), (M = b));
