...
!(function(t, e) {
  ...
  function m(r) {
    return function(t) {
      for (var e = 0; e < r.length; e++) if (r[e][0](t)) return r[e][1](t);
    };
  }
      ...
      return t.reduce(function(t, e) {
        return (
          (t[e] =
            ...
            function() {
              throw new Error(
                'No implementation for ' + r + '. The framework specific code did not implement this method.'
              );
            })),
          t
        );
  ...
  function kt(t, e) {
    ...
    if (f(C)(o)) return !0;
    if (
      [C, O, x, j].map(h).reduce(function(t, e) {
        return t || !!e(o);
      }, !1)
    )
      return !1;
    ...
    It = (function() {
      ...
      return (
        ...
        (t.prototype.evict = function() {
          ...
          return (
            this._evictListeners.forEach(function(t) {
              return t(e);
            }),
            e
          );
  ...
  ((Ot = d.RejectType || (d.RejectType = {}))[(Ot.SUPERSEDED = 2)] = 'SUPERSEDED'),
    (Ot[(Ot.ABORTED = 3)] = 'ABORTED'),
    (Ot[(Ot.INVALID = 4)] = 'INVALID'),
    (Ot[(Ot.IGNORED = 5)] = 'IGNORED'),
    (Ot[(Ot.ERROR = 6)] = 'ERROR');
  var Ht = 0,
    At = (function() {
      function n(t, e, r) {
      ...
      return (
        (n.isRejectionPromise = function(t) {
        ...
        (n.redirected = function(t) {
          return n.superseded(t, { redirected: !0 });
        }),
        ...
        (n.prototype.toString = function() {
          var t,
            e = (t = this.detail) && t.toString !== Object.prototype.toString ? t.toString() : Bt(t);
          return (
        ...
        (n.prototype.toPromise = function() {
          return L(jt(this), { _transitionRejection: this });
        }),
        n
      );
    })();
  ...
  var re,
    ne = Function.prototype.bind.call(console.log, console),
    ie = C(console.table) ? console.table.bind(console) : ne.bind(console);
  ((re = d.Category || (d.Category = {}))[(re.RESOLVE = 0)] = 'RESOLVE'),
    (re[(re.TRANSITION = 1)] = 'TRANSITION'),
    (re[(re.HOOK = 2)] = 'HOOK'),
    (re[(re.UIVIEW = 3)] = 'UIVIEW'),
    (re[(re.VIEWCONFIG = 4)] = 'VIEWCONFIG');
  var oe = R('$id'),
    ae = R('router.$id'),
    ue = function(t) {
    ...
    se = (function() {
      ...
      return (
        ...
        (t.prototype.traceResolvableResolved = function(t, e) {
          this.enabled(d.Category.RESOLVE) &&
            console.log(ue(e) + ':               <- Resolved  ' + t + ' to: ' + Dt(200, Bt(t.data)));
        }),
        ...
        (t.prototype.traceSuccess = function(t, e) {
          this.enabled(d.Category.TRANSITION) &&
            console.log(ue(e) + ': <- Success  ' + Bt(e) + ', final state: ' + t.name);
        }),
        (t.prototype.traceUIViewEvent = function(t, e, r) {
          void 0 === r && (r = ''),
            this.enabled(d.Category.UIVIEW) && console.log('ui-view: ' + qt(30, t) + ' ' + te(e) + r);
        }),
        (t.prototype.traceUIViewConfigUpdated = function(t, e) {
          this.enabled(d.Category.UIVIEW) &&
        ...
        (t.prototype.traceViewServiceEvent = function(t, e) {
          var r, n, i;
          this.enabled(d.Category.VIEWCONFIG) &&
            console.log(
              'VIEWCONFIG: ' +
                t +
                ' ' +
                ((n = (r = e).viewDecl),
                (i = n.$context.name || '(root)'),
                '[View#' +
                  r.$id +
                  " from '" +
                  i +
  ...
  function le(n, i) {
    ...
    function s(o) {
      return function(t, e) {
        ...
        for (var i = 0; i < r.length; i++) if (!o(r[i], n[i])) return !1;
        return !0;
      };
    }
  ...
  function de(t, e, r) {
    var n = (!1 === r.reloadOnSearch && e === d.DefType.SEARCH) || void 0,
      ...
      a = (function(t) {
        ...
        (t = ve(t) ? { value: t } : t), (e.__cacheable = !0);
        var r = V(t.value) ? t.value : e;
        return L(t, { $$fn: r });
      })(r && r.params && r.params[t]);
    return L(o, a);
  }
  ((he = d.DefType || (d.DefType = {}))[(he.PATH = 0)] = 'PATH'),
    (he[(he.SEARCH = 1)] = 'SEARCH'),
    (he[(he.CONFIG = 2)] = 'CONFIG');
  var me,
    ye = (function() {
      function n(t, e, r, n, i) {
        ...
        var a,
          u,
          s =
            ((a = { array: r === d.DefType.SEARCH && 'auto' }),
            (u = t.match(/\[\]$/) ? { array: !0 } : {}),
            L(a, u, o).array);
          ...
          return (
            ...
            _(t)
              ? (function() {
                  ...
                  return i.config.$$fn.__cacheable && (i._defaultValueCache = { defaultValue: t }), t;
                })()
    ...
    ge = (function() {
      function t() {
        (this.enqueue = !0),
          (this.typeQueue = []),
          (this.defaultTypes = it(t.prototype, [
            'hash',
            'string',
            'query',
            'path',
        ...
        this.types = z(
          ft(this.defaultTypes, function(t, e) {
            return new fe(L({ name: e }, t));
          }),
          {}
        );
      }
      return (
        ...
        (t.prototype.type = function(t, e, r) {
          ...
          return (
            (this.types[t] = new fe(L({ name: t }, e))),
  ...
  (me = function(t) {
    ...
    L(ge.prototype, {
      ...
      json: me({ encode: F, decode: U, is: p(Object), equals: M, pattern: /[^/]*/ }),
      any: me({
        encode: B,
        decode: B,
        is: function() {
  ...
  var we = (function() {
    ...
    _e = (function() {
      function n(t) {
        if (t instanceof n) {
          ...
          (this.state = e.state),
            ...
            (this.paramValues = L({}, e.paramValues)),
            (this.resolvables = e.resolvables.slice()),
            (this.views = e.views && e.views.slice());
        } else {
          var r = t;
          (this.state = r),
            (this.paramSchema = r.parameters({ inherit: !1 })),
            (this.paramValues = {}),
      ...
      return (
        ...
        (n.prototype.applyRawParams = function(n) {
          return (
            (this.paramValues = this.paramSchema.reduce(function(t, e) {
    ...
    $e = (function() {
      function h() {}
      return (
        (h.makeTargetState = function(t, e) {
          var r = Ct(e).state;
        ...
        (h.treeChanges = function(t, n, e) {
          for (
            var r, i, o, a, u, s, c = Math.min(t.length, n.length), f = 0;
            f < c && t[f].state !== e && ((r = t[f]), (i = n[f]), r.equals(i, h.nonDynamicParams));
          ...
          return (
            (s = n.slice(f)),
            { from: o, to: l.concat(s), retained: a, retainedWithToParams: l, exiting: u, entering: s }
          );
        }),
    ...
    Ee = (function() {
      function a(t, e, r, n, i) {
        if (((this.resolved = !1), (this.promise = void 0), t instanceof a)) L(this, t);
          ...
          (this.token = t),
            ...
            (this.deps = r || []),
            (this.data = i),
            (this.resolved = void 0 !== i),
            (this.promise = this.resolved ? A.$q.when(this.data) : void 0);
      ...
      return (
        (a.prototype.getPolicy = function(t) {
          var e = this.policy || {},
            r = (t && t.resolvePolicy) || {};
          return { when: e.when || r.when || Re.when, async: e.async || r.async || Re.async };
        }),
        (a.prototype.resolve = function(e, r) {
          ...
          return (this.promise = t
            ...
            .then(function() {
              return t.all(
                e.getDependencies(n).map(function(t) {
                  return t.get(e, r);
                })
              );
            })
    ...
    Oe = (function() {
      ...
      return (
        ...
        (t.prototype.subContext = function(e) {
          return new t(
            $e.subPath(this._path, function(t) {
              return t.state === e;
            })
          );
        }),
  ...
  var He = function(a, u) {
    return function(t) {
      ...
      var n = t.parent,
        ...
        o = i ? a.compile(i.val, { state: e }) : e.url;
      if (!o) return null;
        ...
        [
          ...
          function(t) {
            return new Ee(
              t.token,
              t.val,
              ((e = t.val), (r = A.$injector), e.$inject || (r && r.annotate(e, r.strictDi)) || 'deferred'),
              t.policy
            );
            var e, r;
          },
      ...
      function t(e, t) {
        ...
        this.builders = {
          ...
          params: [
            ((n = t.paramFactory),
            function(r) {
              var t = (r.url && r.url.parameters({ inherit: !1 })) || [],
                e = lt(
                  ct(ot(r.params || {}, t.map(w('id'))), function(t, e) {
      ...
      return (
        (r.create = function(t) {
          ...
          return (
            ...
            (e.self = t),
            (e.__stateObjectCache = { nameGlob: Vt.fromString(e.name) }),
            e
          );
        }),
        ...
        (r.prototype.parameters = function(e) {
          return (
            ((e = et(e, { inherit: !0, matchingKeys: null })).inherit && this.parent && this.parent.parameters()) ||
            []
          )
            .concat(lt(this.params))
            .filter(function(t) {
    ...
    Be = (function() {
      ...
      return (
        ...
        (t.prototype.register = function(t) {
          ...
          if (this.states.hasOwnProperty(n) || J(e.map(w('name')), n))
    ...
    Ge = (function() {
      function t(t) {
        (this.router = t),
          (this.states = {}),
          (this.listeners = []),
          (this.matcher = new Me(this.states)),
          (this.builder = new Ne(this.matcher, t.urlMatcherFactory)),
          (this.stateQueue = new Be(t, this.states, this.builder, this.listeners)),
          this._registerRoot();
      }
      return (
  ...
  ((Ue = d.TransitionHookPhase || (d.TransitionHookPhase = {}))[(Ue.CREATE = 0)] = 'CREATE'),
    (Ue[(Ue.BEFORE = 1)] = 'BEFORE'),
    (Ue[(Ue.RUN = 2)] = 'RUN'),
    (Ue[(Ue.SUCCESS = 3)] = 'SUCCESS'),
    (Ue[(Ue.ERROR = 4)] = 'ERROR'),
    ((Fe = d.TransitionHookScope || (d.TransitionHookScope = {}))[(Fe.TRANSITION = 0)] = 'TRANSITION'),
    (Fe[(Fe.STATE = 1)] = 'STATE');
  var We = { current: G, transition: null, traceData: {}, bind: null },
    ze = (function() {
      function o(t, e, r, n) {
        var i = this;
        (this.transition = t),
      ...
      return (
        ...
        (o.prototype.invokeHook = function() {
          ...
          if (!r._deregistered) {
            ...
            try {
              ...
              return !this.type.synchronous && I(a)
                ? a
                    .catch(function(t) {
        ...
        (o.prototype.handleHookResult = function(t) {
          ...
          return (
            ...
            (I(t)
              ...
              : (ce.traceHookResult(t, this.transition, this.options),
                !1 === t
                  ? At.aborted('Hook aborted transition').toPromise()
                  : p(Se)(t)
                  ? At.redirected(t).toPromise()
                  : void 0))
          );
        }),
        (o.prototype.getNotCurrentRejection = function() {
          ...
          return t._disposed
            ? At.aborted('UIRouter instance #' + t.$id + ' has been stopped (disposed)').toPromise()
            : this.transition._aborted
            ? At.aborted().toPromise()
            : this.isSuperseded()
            ? At.superseded(this.options.current()).toPromise()
            : void 0;
        }),
        (o.prototype.toString = function() {
          ...
          return (
            (R('traceData.hookType')(t) || 'internal') +
            ' context: ' +
            (R('traceData.context.state.name')(t) || R('traceData.context')(t) || 'unknown') +
            ', ' +
            Dt(200, Nt(e.callback))
          );
        }),
  ...
  var Qe = (function() {
    ...
    return (
      (t.prototype._matchingNodes = function(t, e, r) {
        if (!0 === e) return t;
  ...
  var Ye = (function() {
    ...
    return (
      ...
      (t.prototype.buildHooks = function(o) {
        ...
        if (!e) return [];
        var u = { transition: a, current: a.options().current };
        return e
          .map(function(i) {
            return i.matches(t, a)[o.criteriaMatchPath.name].map(function(t) {
              var e = L({ bind: i.bind, traceData: { hookType: o.name, context: t } }, u),
                r = o.criteriaMatchPath.scope === d.TransitionHookScope.STATE ? t.state.self : null,
                n = new ze(a, r, i, e);
              return { hook: i, node: t, transitionHook: n };
            });
          })
          .reduce(vt, [])
          .sort(
      ...
      (t.prototype.getMatchingHooks = function(e, r, n) {
        ...
        return (t ? [i] : [this.transition, i])
          .map(function(t) {
            return t.getHooks(e.name);
          })
          .filter(_t(O, 'broken event named: ' + e.name))
          .reduce(vt, [])
          .filter(function(t) {
  ...
  var Ze = w('self'),
    Xe = (function() {
      function e(t, e, r) {
        var n = this;
        if (
          ((this._deferred = A.$q.defer()),
          (this.promise = this._deferred.promise),
          (this._registeredHooks = {}),
          (this._hookBuilder = new Ye(this)),
          (this.isActive = function() {
            return n.router.globals.transition === n;
          }),
          (this.router = r),
          !(this._targetState = e).valid())
        )
          throw new Error(e.error());
        (this._options = L({ current: v(this) }, e.options())), (this.$id = r.transitionService._transitionCount++);
      ...
      return (
        ...
        (e.prototype.exiting = function() {
          return ft(this._treeChanges.exiting, w('state'))
            .map(Ze)
            .reverse();
        }),
        ...
        (e.prototype.views = function(t, e) {
          void 0 === t && (t = 'entering');
          var r = this._treeChanges[t];
          return (r = e ? r.filter(y('state', e)) : r)
            .map(w('views'))
            .filter(B)
            .reduce(vt, []);
        }),
        ...
        (e.prototype.redirect = function(t) {
          ...
          return (
            $e
              .matching(s, u, $e.nonDynamicParams)
              .filter(
                l(
        ...
        (e.prototype._ignoredReason = function() {
          var t = this.router.globals.transition,
            ...
            r = this.treeChanges(),
            i = t && t.treeChanges();
          return i && e(i.to, r.to) && e(i.exiting, r.exiting)
            ? 'SameAsPending'
            : 0 === r.exiting.length && 0 === r.entering.length && e(r.from, r.to)
            ? 'SameAsCurrent'
            : void 0;
        }),
        (e.prototype.run = function() {
          ...
          return (
            ze
              ...
              .then(
                function() {
                  ce.traceSuccess(e.$to(), e),
                    (e.success = !0),
                    e._deferred.resolve(e.to()),
                    r(n(d.TransitionHookPhase.SUCCESS));
                },
                function(t) {
                  ce.traceError(t, e),
                    (e.success = !1),
                    e._deferred.reject(t),
                    (e._error = t),
                    r(n(d.TransitionHookPhase.ERROR));
                }
              ),
            this.promise
          );
        ...
        (e.prototype.toString = function() {
          ...
          return (
            ...
            (k(t) ? t.name : t) +
            "'" +
            Bt(r(this._treeChanges.from.map(w('paramValues')).reduce(rt, {}))) +
            ' -> ' +
            (this.valid() ? '' : '(X) ') +
            "'" +
            (k(e) ? e.name : e) +
  ...
  var er = Zt('/'),
      ...
      function m(o, a, t, e) {
        ...
        for (
          var r,
            ...
            l = 0,
            h = function(t) {
              if (!m.nameValidator.test(t))
                throw new Error("Invalid parameter name '" + t + "' in pattern '" + o + "'");
              if (st(u._params, y('id', t)))
                throw new Error("Duplicate parameter name '" + t + "' in pattern '" + o + "'");
            },
            p = function(t, e) {
              var r,
                n = t[2] || t[3],
              ...
              return {
                ...
                type: i
                  ? a.type(i) ||
                    ((r = i),
                    z(a.type(e ? 'query' : 'path'), {
                      pattern: new RegExp(r, u.config.caseInsensitive ? 'i' : void 0),
                    }))
                  : null,
              };
            };
          (r = s.exec(o)) && !(0 <= (n = p(r, !1)).segment.indexOf('?'));

        )
          h(n.id),
            this._params.push(t.fromPath(n.id, n.type, e.state)),
            this._segments.push(n.segment),
            f.push([n.segment, Ct(this._params)]),
            (l = s.lastIndex);
        ...
        if (0 <= v) {
          ...
          if (((i = i.substring(0, v)), 0 < d.length))
            for (l = 0; (r = c.exec(d)); )
              h((n = p(r, !0)).id), this._params.push(t.fromSearch(n.id, n.type, e.state)), (l = s.lastIndex);
        }
      ...
      return (
        ...
        (m.compare = function(t, e) {
          ...
          var o,
            a,
            u = Rt(n, i);
          for (a = 0; a < u.length; a++) if (0 !== (o = u[a][0] - u[a][1])) return o;
          return 0;
        }),
        ...
        (m.prototype.exec = function(t, n, e, r) {
          ...
          var o,
            ...
            (u = function() {
              return new RegExp(
                ['^', gt(i._cache.path.map(w('_compiled'))).join(''), !1 === i.config.strict ? '/?' : '', '$'].join(''),
          ...
          for (var d = 0; d < p; d++) {
            for (var m = l[d], y = s[d + 1], g = 0; g < m.replace.length; g++)
              m.replace[g].from === y && (y = m.replace[g].to);
            y &&
              !0 === m.array &&
              (void 0,
              (y = ft(
        ...
        (m.prototype.format = function(a) {
          ...
          function n(t) {
            var e = t.value(a[t.id]),
              ...
              i = !!n && t.squash,
              o = t.type.encode(e);
            return { param: t, value: e, isValid: r, isDefaultValue: n, squash: i, encoded: o };
          }
            ...
            o = r
              .map(function(t) {
                var e = t.param,
                  ...
                  n = t.encoded,
                  i = t.isDefaultValue;
                if (!(null == n || (i && !1 !== r)) && (O(n) || (n = [n]), 0 !== n.length))
                  return (
                    e.raw || (n = ft(n, encodeURIComponent)),
                    n.map(function(t) {
                      return e.id + '=' + t;
                    })
                  );
    ...
    ar = (function() {
      function t(t) {
        var n = this;
        (this.router = t),
          (this.paramFactory = new or(this.router)),
          ...
          L(this, { UrlMatcher: nr, Param: ye });
      }
      return (
        (t.prototype.compile = function(t, e) {
          var r = this.router.urlService.config,
            n = e && !e.state && e.params;
          e = n ? ir({ state: { params: n } }, e) : e;
          var i = { strict: r._isStrictMode, caseInsensitive: r._isCaseInsensitive };
    ...
    ur = (function() {
      ...
      return (
        ...
        (t.prototype.fromUrlMatcher = function(r, e) {
          var t = e;
          P(e) && (e = this.router.urlMatcherFactory.compile(e)),
            p(nr)(e) &&
              (t = function(t) {
                return e.format(t);
              });
        ...
        (t.prototype.fromState = function(n, i) {
          var t = { state: n, type: 'STATE' };
          return L(
            this.fromUrlMatcher(n.url, function(t) {
              var e = i.stateService,
                r = i.globals;
              e.href(n, t) !== e.href(r.current, r.params) && e.transitionTo(n, t, { inherit: !0, source: 'url' });
            }),
            t
          );
        }),
        ...
        (t.isUrlRule = function(e) {
          return (
            e &&
            ['type', 'match', 'handler'].every(function(t) {
              return E(e[t]);
            })
          );
        }),
  ...
  var cr,
      ...
      return (
        ...
        (t.prototype.href = function(t, e, r) {
          ...
          var i,
            ...
            a,
            u,
            s = this.router.urlService.config,
            c = s.html5Mode();
          if (
            (c || null === n || (n = '#' + s.hashPrefix() + n),
            (i = n),
            (o = c),
            (a = r.absolute),
            (n = '/' === (u = s.baseHref()) ? i : o ? zt(u) + i : a ? u.slice(1) + i : i),
            !r.absolute || !n)
          )
            return n;
          var f = !c && n ? '/' : '',
    ...
    lr = (function() {
      ...
      return (
        (s.normalizeUIViewTarget = function(t, e) {
          void 0 === e && (e = '');
          var r = e.split('@'),
            n = r[0] || '$default',
            i = P(r[1]) ? r[1] : '^',
          ...
          var o = c(function(t, e, r, n) {
            ...
            t = this._uiViews
              ...
              .map(function(t) {
                ...
                return 1 < e.length && e.sort(o(i, -1)), { uiView: t, viewConfig: e[0] };
              }),
            e = t.map(function(t) {
              return t.viewConfig;
            }),
        ...
        (s.prototype.registerUIView = function(e) {
          ...
          return (
            ...
            }).length && ce.traceViewServiceUIViewEvent('!!!! duplicate uiView named:', e),
            t.push(e),
            this.sync(),
            function() {
              -1 !== t.indexOf(e)
                ? (ce.traceViewServiceUIViewEvent('<- Deregistering', e), K(t)(e))
                : ce.traceViewServiceUIViewEvent('Tried removing non-registered uiView', e);
            }
          );
        }),
    ...
    hr = (function() {
      function t() {
        (this.params = new we()),
          ...
          (this.transitionHistory = new It([], 1)),
          (this.successfulTransitions = new It([], 1));
      }
      return (
        (t.prototype.dispose = function() {
  ...
  cr = function(t, e) {
    var r,
      ...
      s,
      c,
      f = ((r = t), (e.priority || 0) - (r.priority || 0));
    return 0 !== f
      ? f
      : ((n = e),
        0 !== (f = ((i = { STATE: 4, URLMATCHER: 4, REGEXP: 3, RAW: 2, OTHER: 1 })[t.type] || 0) - (i[n.type] || 0))
          ? f
          : ((a = e),
            0 !== (f = (o = t).urlMatcher && a.urlMatcher ? nr.compare(o.urlMatcher, a.urlMatcher) : 0)
              ? f
              : ((s = e),
                (c = { STATE: !0, URLMATCHER: !0 })[(u = t).type] && c[s.type] ? 0 : (u.$id || 0) - (s.$id || 0))));
  };
  var vr = (function() {
      function t(t) {
      ...
      return (
        ...
        (t.prototype.sort = function(t) {
          for (
            var e = this.stableSort(this._rules, (this._sortFn = t || this._sortFn)), r = 0, n = 0;
            n < e.length;
            n++
          )
            (e[n]._group = r), n < e.length - 1 && 0 !== this._sortFn(e[n], e[n + 1]) && r++;
    ...
    mr = (function() {
      function t(t) {
        ...
        (this.router = t),
          ...
          (this.rules = new vr(this.router)),
          (this.config = new dr(this.router)),
      ...
      return (
        ...
        (t.prototype.match = function(t) {
          var e = this;
          t = L({ path: '', search: {}, hash: '' }, t);
          for (var r, n, i, o = this.rules.rules(), a = 0; a < o.length && (!r || r.rule._group === o[a]._group); a++) {
            var u =
              ((n = o[a]), void 0, (i = n.match(t, e.router)) && { match: i, rule: n, weight: n.matchPriority(i) });
    ...
    _r = (function() {
      function t(t, e) {
        void 0 === t && (t = gr),
          ...
          (this._disposables = []),
          (this.trace = ce),
          (this.viewService = new lr(this)),
          (this.globals = new hr()),
          (this.transitionService = new Lr(this)),
          (this.urlMatcherFactory = new ar(this)),
          (this.urlRouter = new fr(this)),
          (this.urlService = new mr(this)),
          (this.stateRegistry = new Ge(this)),
  ...
  function Sr(e) {
    e.addResolvable(Ee.fromData(_r, e.router), ''),
      e.addResolvable(Ee.fromData(Xe, e), ''),
      e.addResolvable(Ee.fromData('$transition$', e), ''),
      e.addResolvable(Ee.fromData('$stateParams', e.params()), ''),
      ...
      function n(t) {
        if (t)
          return t instanceof Se
            ? t
            : P(t)
            ? r.target(t, e.params(), e.options())
            : t.state || t.params
            ? r.target(t.state || e.to(), t.params || e.params(), e.options())
            : void 0;
      }
    };
  function Er(r) {
  ...
  var qr = function(t, e, r, n, i, o, a, u) {
    void 0 === i && (i = !1),
      void 0 === o && (o = ze.HANDLE_RESULT),
      void 0 === a && (a = ze.REJECT_ERROR),
      void 0 === u && (u = !1),
      (this.name = t),
      (this.hookPhase = e),
      (this.hookOrder = r),
  ...
  var Nr = {
    ...
    Lr = (function() {
      function t(t) {
        (this._transitionCount = 0),
          ...
          (this._pluginapi = W(v(this), {}, v(this), [
            '_definePathType',
            '_defineEvent',
            '_getPathTypes',
            '_getEvents',
      ...
      return (
        (t.prototype.onCreate = function(t, e, r) {}),
        ...
        (t.prototype._defineCoreEvents = function() {
          ...
          this._defineEvent('onCreate', t.CREATE, 0, r.to, !1, e.LOG_REJECTED_RESULT, e.THROW_ERROR, !0),
            this._defineEvent('onBefore', t.BEFORE, 0, r.to),
            this._defineEvent('onStart', t.RUN, 0, r.to),
            this._defineEvent('onExit', t.RUN, 100, r.exiting, !0),
            this._defineEvent('onRetain', t.RUN, 200, r.retained),
            this._defineEvent('onEnter', t.RUN, 300, r.entering),
            this._defineEvent('onFinish', t.RUN, 400, r.to),
            this._defineEvent('onSuccess', t.SUCCESS, 0, r.to, !1, e.LOG_REJECTED_RESULT, e.LOG_ERROR, !0),
            this._defineEvent('onError', t.ERROR, 0, r.to, !1, e.LOG_REJECTED_RESULT, e.LOG_ERROR, !0);
        }),
        ...
        (t.prototype._getEvents = function(e) {
          return (E(e)
            ? this._eventTypes.filter(function(t) {
        ...
        (t.prototype._registerCoreTransitionHooks = function() {
          ...
          (t.addCoreResolves = this.onCreate({}, Sr)),
            (t.ignored = this.onBefore({}, Ur, { priority: -9999 })),
            (t.invalid = this.onBefore({}, Fr, { priority: -1e4 })),
            ...
            (t.eagerResolve = this.onStart({}, kr, { priority: 1e3 })),
            (t.lazyResolve = this.onEnter({ entering: v(!0) }, Or, { priority: 1e3 })),
            (t.resolveAll = this.onFinish({}, xr, { priority: 1e3 })),
            (t.loadViews = this.onFinish({}, jr)),
            (t.activateViews = this.onSuccess({}, Vr)),
            (t.updateGlobals = this.onCreate({}, Ir)),
            (t.updateUrl = this.onSuccess({}, Hr, { priority: 9999 })),
    ...
    Mr = (function() {
      ...
      return (
        Object.defineProperty(r.prototype, 'transition', {
          get: function() {
            ...
            c = function(t) {
              if (t instanceof Se) {
                ...
                return (e = n.target(e.identifier(), e.params(), e.options())).valid()
                  ? o() !== a
                    ? At.superseded().toPromise()
                    : n.transitionTo(e.identifier(), e.params(), e.options())
                  : At.invalid(e.error()).toPromise();
              }
            };
          return (function e() {
            var t = u.dequeue();
            return void 0 === t
              ? At.invalid(r.error()).toPromise()
              : A.$q
                  .when(t(r, i, s))
                  .then(c)
                  .then(function(t) {
        ...
        (r.prototype.go = function(t, e, r) {
          var n = et(r, { relative: this.$current, inherit: !0 }, Nr);
        ...
        (r.prototype.transitionTo = function(t, e, r) {
          ...
          var s = function(i) {
            ...
            f = c.run().catch(s(c));
          return xt(f), L(f, { transition: c });
        }),
        (r.prototype.is = function(t, e, r) {
          r = et(r, { relative: this.$current });
        ...
        (r.prototype.href = function(t, e, r) {
          (r = et(r, { lossy: !0, inherit: !0, absolute: !1, relative: this.$current })), (e = e || {});
          var n = this.router.stateRegistry.matcher.find(t, r.relative);
          if (!E(n)) return null;
    ...
    hn = (function() {
      ...
      return (
        ...
        (t.prototype.baseHref = function(t) {
          return (
            E(t) && (this._baseHref = t), _(this._baseHref) && (this._baseHref = this.getBaseHref()), this._baseHref
          );
        }),
  ...
  function Sn(n) {
    ...
    var i = ['component', 'bindings', 'componentProvider'],
      o = ['templateProvider', 'templateUrl', 'template', 'notify', 'async'].concat([
        'controller',
        'controllerProvider',
        'controllerAs',
        'resolveAs',
    ...
    var a = {},
      e = n.views || { $default: it(n, t) };
    return (
      N(e, function(t, e) {
        if (((e = e || '$default'), P(t) && (t = { component: t }), (t = L({}, t)), _n(i, t) && _n(o, t)))
          throw new Error(
            'Cannot combine: ' + i.join('|') + ' with: ' + o.join('|') + " in stateview: '" + e + '@' + n.name + "'"
          );
  ...
  var $n = 0,
    ...
    Rn = (function() {
      function t() {
        var n = this;
        (this._useHttp = b.version.minor < 3),
          (this.$get = [
            '$http',
            '$templateCache',
            '$injector',
            function(t, e, r) {
              return (
                (n.$templateRequest = r.has && r.has('$templateRequest') && r.get('$templateRequest')),
                (n.$http = t),
                (n.$templateCache = e),
                n
              );
  ...
  var En = function(t) {
    ...
    Tn = (function() {
      ...
      return (
        (r.prototype.decorator = function(t, e) {
    ...
    On = (function() {
      ...
      return (
        (r.injectableHandler = function(e, r) {
          return function(t) {
            return A.$injector.invoke(r, null, { $match: t, $stateParams: e.globals.params });
          };
        }),
        ...
        (r.prototype.when = function(t, e) {
          return (
            (O(e) || C(e)) && (e = r.injectableHandler(this.router, e)), this.router.urlService.rules.when(t, e), this
          );
        }),
  ...
  function Dn(t) {
    ((An = this.router = new _r()).stateProvider = new Tn(An.stateRegistry, An.stateService)),
      An.stateRegistry.decorator('views', Sn),
      An.stateRegistry.decorator('onExit', Pn('onExit')),
      An.stateRegistry.decorator('onRetain', Pn('onRetain')),
      An.stateRegistry.decorator('onEnter', Pn('onEnter')),
      An.viewService._pluginapi._viewConfigFactory('ng1', wn());
    ...
    return (
      kn.monkeyPatchPathParameterType(An),
      (((An.router = An).$get = e).$inject = [
        '$location',
        '$browser',
        '$window',
        '$sniffer',
  ...
  function Un(e, t, r) {
    if (((A.$injector = e), (A.$q = t), !e.hasOwnProperty('strictDi')))
      try {
        e.invoke(function(t) {});
      } catch (t) {
  ...
  (Fn.$inject = ['$rootScope']),
    xn.provider('$uiRouter', Dn),
    Vn.provider('$urlRouter', [
      '$uiRouterProvider',
      function(t) {
        return (t.urlRouterProvider = new On(t));
      },
    ]),
    jn.provider('$urlService', qn('urlService')),
    jn.provider('$urlMatcherFactory', [
      '$uiRouterProvider',
      function() {
    ...
    In.provider('$stateRegistry', qn('stateRegistry')),
    In.provider('$uiRouterGlobals', qn('globals')),
    In.provider('$transitions', qn('transitionService')),
    In.provider('$state', [
      '$uiRouterProvider',
      function() {
    ...
    Hn.run(Fn),
    jn.run(['$urlMatcherFactory', function(t) {}]),
    In.run(['$state', function(t) {}]),
    Vn.run(['$urlRouter', function(t) {}]),
    xn.run(Un);
  var Nn,
    Ln,
    Mn,
  ...
  function Jn(t, e, r) {
    var n,
      i = r.uiState || t.current.name,
      o = L(((n = t), { relative: zn(e) || n.$current, inherit: !0, source: 'sref' }), r.uiStateOpts || {}),
      ...
      compile: function(t) {
        ...
        return (
          ...
          function(e, r) {
            ...
            var n = t.$cfg || { viewDecl: {}, getTemplate: G },
            ...
            var o = d(r.contents()),
              ...
              c = i && Gn(i);
            if (((e[s] = c), a)) {
              var f = m(a, L({}, c, { $scope: e, $element: r }));
              u && ((e[u] = f), (e[u][s] = c)),
                r.data('$ngControllerController', f),
                r.children().data('$ngControllerController', f),
                ni(g, y, f, e, n);
            }
            if (P(n.component))
              var l = Ut(n.component),
  ...
  (Nn = [
    ...
    function(h, p) {
      ...
      return {
        ...
        link: function(t, e, r, n) {
          ...
          (s.uiState = f.state),
            (s.uiStateOpts = r.uiSrefOpts ? t.$eval(r.uiSrefOpts) : {}),
            f.paramExpr &&
              (t.$watch(
                f.paramExpr,
                function(t) {
              ...
              (s.uiStateParams = L({}, t.$eval(f.paramExpr)))),
            l(),
            t.$on('$destroy', h.stateRegistry.onStatesChanged(l)),
            t.$on('$destroy', h.transitionService.onSuccess({}, l)),
            o.clickable && ((i = Kn(e, v, p, o, c)), Yn(e, t, i, s.uiStateOpts));
        },
      };
    },
  ]),
        ...
        return {
          ...
          link: function(r, t, n, e) {
            ...
            function h() {
              var t = c();
              u && u(),
                a && (u = a.$$addStateInfo(t.uiState, t.uiStateParams)),
                null != t.href && n.$set(o.attr, t.href);
            }
            f.forEach(function(e) {
              (s[e] = n[e] ? r.$eval(n[e]) : null),
              ...
              h(),
              r.$on('$destroy', p.stateRegistry.onStatesChanged(h)),
              r.$on('$destroy', p.transitionService.onSuccess({}, h)),
              o.clickable && ((i = Kn(t, d, v, o, c)), Yn(t, r, i, s.uiStateOpts));
          },
        };
      },
    ]),
        ...
        return {
          ...
          controller: [
            ...
            function(u, s, t) {
              ...
              function h(t, e, r) {
                var n = { state: v.get(t, zn(s)) || { name: t }, params: e, activeClass: r };
                return (
                  f.push(n),
                  function() {
                    K(f)(n);
              ...
              l((n = n || d(t.uiSrefActive || '', !1)(u))),
                ...
                u.$on(
                  '$destroy',
                  ((e = m.stateRegistry.onStatesChanged(a)),
                  (r = m.transitionService.onStart({}, o)),
                  (i = u.$on('$stateChangeSuccess', p)),
                  function() {
                    e(), r(), i();
                  })
                ),
                m.globals.transition && o(m.globals.transition),
                p();
            },
          ],
        };
    ...
    b
      ...
      .directive('uiSref', Nn)
      .directive('uiSrefActive', Mn)
      .directive('uiSrefActiveEq', Mn)
      .directive('uiState', Ln),
    (Zn.$inject = ['$state']),
    (Xn.$inject = ['$state']),
    b
      .module('ui.router.state')
      .filter('isState', Zn)
      .filter('includedByState', Xn),
    (Bn = [
      '$view',
      '$animate',
      '$uiViewScroll',
      ...
      '$q',
      function(i, o, g, w, _) {
        var S = { $cfg: { viewDecl: { $context: i._pluginapi._rootViewContext() } }, $uiView: {} },
          $ = {
            count: 0,
            restrict: 'ECA',
            terminal: !0,
            ...
            compile: function(t, e, y) {
              return function(a, u, t) {
                ...
                function n(t) {
                  ...
                  e.$emit('$viewContentLoading', d),
                    (c = y(e, function(t) {
                      t.data('$uiViewAnim', o),
                        t.data('$uiView', i),
                        v.enter(t, u, function() {
                          r.resolve(), f && f.$emit('$viewContentAnimationEnded'), ((E(p) && !p) || a.$eval(p)) && g(t);
                        }),
                        (function() {
                          if (
                            (s &&
                              (ce.traceUIViewEvent('Removing (previous) el', s.data('$uiView')),
                              s.remove(),
                              (s = null)),
                            f && (ce.traceUIViewEvent('Destroying scope', m), f.$destroy(), (f = null)),
                            c)
                          ) {
                            var t = c.data('$uiViewAnim');
                            ce.traceUIViewEvent('Animate out', t),
                              v.leave(c, function() {
                    ...
                    (f = e).$emit('$viewContentLoaded', t || l),
                    f.$eval(h);
                }
                ce.traceUIViewEvent('Linking', m),
                  u.data('$uiView', { $uiView: m }),
                  n(),
                  (e = i.registerUIView(m)),
      ...
      e.$on(
        ...
        t.onBefore(
          ...
          function(t) {
            ...
            return (
              u(t) ||
                (e = n.when(c.uiCanExit(t))).then(function(t) {
                  return (r[o] = !1 !== t);
                }),
              e
            );
  ...
  b.module('ui.router.state').directive('uiView', Bn),
    b.module('ui.router.state').directive('uiView', ti),
    b.module('ui.router.state').provider('$uiViewScroll', function() {
      var r = !1;
  ...
  (d.default = 'ui.router'),
    ...
    (d.watchDigests = Fn),
    (d.getLocals = Gn),
    (d.getNg1ViewConfigFactory = wn),
    (d.ng1ViewsBuilder = Sn),
    (d.Ng1ViewConfig = bn),
    (d.StateProvider = Tn),
    (d.UrlRouterProvider = On),
    (d.root = D),
    (d.fromJson = U),
    (d.toJson = F),
    (d.forEach = N),
    ...
    (d.copy = Tt),
    (d._extend = Pt),
    (d.silenceUncaughtInPromise = xt),
    (d.silentRejection = jt),
    (d.makeStub = H),
    (d.services = A),
    (d.Glob = Vt),
    (d.curry = c),
    ...
    (d.padString = qt),
    (d.kebobString = Ut),
    (d.functionToString = Ft),
    (d.fnToString = Nt),
    (d.stringify = Bt),
    (d.beforeAfterSubstr = Gt),
    (d.hostRegex = Wt),
    (d.stripLastPathElement = zt),
    (d.splitHash = Jt),
    (d.splitQuery = Qt),
    (d.splitEqual = Kt),
    (d.trimHashVal = Yt),
    ...
    (d.PathNode = _e),
    (d.PathUtils = $e),
    (d.resolvePolicies = be),
    (d.defaultResolvePolicy = Re),
    (d.Resolvable = Ee),
    (d.NATIVE_INJECTOR_TOKEN = ke),
    (d.ResolveContext = Oe),
    (d.resolvablesBuilder = qe),
    (d.StateBuilder = Ne),
    (d.StateObject = Le),
    (d.StateMatcher = Me),
    (d.StateQueueManager = Be),
    (d.StateRegistry = Ge),
    (d.StateService = Mr),
    (d.TargetState = Se),
    (d.HookBuilder = Ye),
    ...
    (d.Transition = Xe),
    (d.TransitionHook = ze),
    (d.TransitionEventType = qr),
    (d.defaultTransOpts = Nr),
    (d.TransitionService = Lr),
    (d.UrlRules = vr),
    (d.UrlConfig = dr),
    (d.UrlMatcher = nr),
    (d.ParamFactory = or),
    (d.UrlMatcherFactory = ar),
    (d.UrlRouter = fr),
    (d.UrlRuleFactory = ur),
    (d.BaseUrlRule = sr),
    (d.UrlService = mr),
    (d.ViewService = lr),
    (d.UIRouterGlobals = hr),
    (d.UIRouter = _r),
    (d.$q = Br),
    (d.$injector = Jr),
    (d.BaseLocationServices = nn),
    (d.HashLocationService = an),
    (d.MemoryLocationService = sn),
    (d.PushStateLocationService = fn),
    (d.MemoryLocationConfig = ln),
    (d.BrowserLocationConfig = hn),
    (d.keyValsToObjectR = Qr),
    (d.getParams = Kr),
    (d.parseUrl = Yr),
    (d.buildUrl = Zr),
    (d.locationPluginFactory = Xr),
    (d.servicesPlugin = pn),
    (d.hashLocationPlugin = vn),
    (d.pushStateLocationPlugin = dn),
    (d.memoryLocationPlugin = mn),
    (d.UIRouterPluginBase = yn),
