...
!(function(e, t) {
  'object' == typeof exports && 'object' == typeof module
    ...
    ? (exports['angular-file-upload'] = t())
    : (e['angular-file-upload'] = t());
})(this, function() {
  return (function(e) {
    function t(o) {
    ...
    function(e, t, n) {
      ...
      var r = n(1),
        ...
        x = o(U);
      angular
        .module(i['default'].name, [])
        .value('fileUploaderOptions', a['default'])
        .factory('FileUploader', l['default'])
        .factory('FileLikeObject', c['default'])
        .factory('FileItem', d['default'])
        .factory('FileDirective', y['default'])
        .factory('FileSelect', m['default'])
        .factory('FileDrop', F['default'])
        .factory('FileOver', C['default'])
        .factory('Pipeline', g['default'])
        .directive('nvFileSelect', A['default'])
        .directive('nvFileDrop', T['default'])
        .directive('nvFileOver', x['default'])
        .run([
          'FileUploader',
          'FileLikeObject',
          'FileItem',
        ...
        var b = o.File,
          ...
          O = (function() {
            function o(t) {
              r(this, o);
              var n = p(e);
              c(this, n, t, { isUploading: !1, _nextIndex: 0, _directives: { select: [], drop: [], over: [] } }),
                this.filters.unshift({ name: 'queueLimit', fn: this._queueLimitFilter }),
                this.filters.unshift({ name: 'folder', fn: this._folderFilter });
            }
            return (
              (o.prototype.addToQueue = function(e, t, n) {
                var o = this,
                  ...
                  f = function() {
                    o.queue.length !== l && (o._onAfterAddingAll(p), (o.progress = o._getTotalProgress())),
                      o._render(),
                      o.autoUpload && o.uploadAll();
                  };
                c();
              }),
              ...
              (o.prototype.uploadItem = function(e) {
                ...
                n._prepareToUploading(),
                  this.isUploading ||
                    (this._onBeforeUploadItem(n),
                    n.isCancel || ((n.isUploading = !0), (this.isUploading = !0), this[o](n), this._render()));
              }),
              ...
              (o.prototype._transformResponse = function(e, t) {
                ...
                return (
                  f(n.defaults.transformResponse, function(t) {
                    e = t(e, o);
                  }),
                  e
                );
              ...
              (o.prototype._xhrTransport = function(e) {
                ...
                if (
                  (e.disableMultipart
                    ? (t = e._file)
                    : ((t = new F()),
                      f(e.formData, function(e) {
                        f(e, function(e, n) {
                          t.append(n, e);
                        });
                      }),
                      t.append(e.alias, e._file, e.file.name)),
                  'number' != typeof e._file.size)
                )
                ...
                e._form && e._form.replaceWith(r),
                  ...
                  (n.abort = function() {
                    var i,
                      s = { status: 0, dummy: !0 },
                      a = {};
                    o.unbind('load').prop('src', 'javascript:false;'),
                      n.replaceWith(r),
              ...
              (o.prototype._onCompleteItem = function(e, t, n, o) {
                ...
                return (
                  ...
                  y(r)
                    ? void r.upload()
                    : (this.onCompleteAll(), (this.progress = this._getTotalProgress()), void this._render())
                );
              }),
              (o.isFile = function(e) {
        ...
        function e(e, t) {
          ...
          try {
            for (
              ...
              !(o = (s = a.next()).done) && (n.push(s.value), !t || n.length !== t);
              o = !0
            );
          } catch (u) {
            (r = !0), (i = u);
    ...
    function(e, t, n) {
      ...
      function i() {
        return (function() {
          ...
          return (
            (e.prototype._createFromFakePath = function(e) {
            ...
            (e.prototype._createFromObject = function(e) {
              (this.lastModifiedDate = u(e.lastModifiedDate)),
                (this.size = e.size),
                (this.type = e.type),
                (this.name = e.name);
            }),
          ...
          return (
            ...
            (n.prototype.onChange = function() {
              ...
              this.uploader.isHTML5 || this.destroy(),
                this.uploader.addToQueue(t, n, o),
                this.isEmptyAfterSelection() &&
                  (this.element.prop('value', null), this.element.replaceWith(e(this.element.clone())(this.scope)));
            }),
            n
          );
        })(t);
            ...
            (t.prototype.onDrop = function(e) {
              ...
              if (t) {
                ...
                this._preventAndStop(e),
                  ...
                  this.uploader.addToQueue(t.files, n, o);
              }
            }),
            (t.prototype.onDragOver = function(e) {
              var t = this._getTransfer(e);
              this._haveFiles(t.types) &&
                ((t.dropEffect = 'copy'),
                this._preventAndStop(e),
                c(this.uploader._directives.over, this._addOverClass, this));
            }),
            (t.prototype.onDragLeave = function(e) {
              e.currentTarget !== this.element[0] &&
                (this._preventAndStop(e), c(this.uploader._directives.over, this._removeOverClass, this));
            }),
      ...
      function r(e, t, n) {
        return {
          link: function(o, r, i) {
            ...
            (a.getOptions = e(i.options).bind(a, o)),
