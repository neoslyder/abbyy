...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['angular-file-upload'] = factory();
  else root['angular-file-upload'] = factory();
})(this, function() {
  return /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        angular
          .module(_config2.default.name, [])
          .value('fileUploaderOptions', _options2.default)
          .factory('FileUploader', _FileUploader2.default)
          .factory('FileLikeObject', _FileLikeObject2.default)
          .factory('FileItem', _FileItem2.default)
          .factory('FileDirective', _FileDirective2.default)
          .factory('FileSelect', _FileSelect2.default)
          .factory('FileDrop', _FileDrop2.default)
          .factory('FileOver', _FileOver2.default)
          .factory('Pipeline', _Pipeline2.default)
          .directive('nvFileSelect', _FileSelect4.default)
          .directive('nvFileDrop', _FileDrop4.default)
          .directive('nvFileOver', _FileOver4.default)
          .run([
            'FileUploader',
            'FileLikeObject',
            'FileItem',
